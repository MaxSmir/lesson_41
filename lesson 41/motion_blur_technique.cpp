...
bool MotionBlurTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/Users/sofya/source/repos/lr6 IiKG/lesson 41/lesson 41/shaders/motion_blur.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/Users/sofya/source/repos/lr6 IiKG/lesson 41/lesson 41/shaders/motion_blur.fs")) {
        return false;
    }
